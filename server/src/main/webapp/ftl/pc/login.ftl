...
<html>
    ...
    <form name="login_form" action="/rest/j_spring_security_check" method="POST">
        <table>
            <tr>
                <td>User:</td>
            ...
            <tr>
                <td colspan='1'><input type="submit" class="form-control" id="submit" name="submit" placeholder="Login"></td>
            </tr>
            <tr>
